...
namespace ApartmentManagementSystem.Infrastructure.Migrations
{
    ...
    [Migration("20260315193458_UnitOfWorkMigratee")]
    partial class UnitOfWorkMigratee
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ApartmentManagementSystem.Domain.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2026, 3, 15, 19, 34, 57, 383, DateTimeKind.Utc).AddTicks(5163),
                            Name = "SuperAdmin"
                        },
                        new
                        {
                            Id = new Guid("10000000-0000-0000-0000-000000000002"),
                            CreatedAt = new DateTime(2026, 3, 15, 19, 34, 57, 383, DateTimeKind.Utc).AddTicks(5168),
                            Name = "Manager"
                        },
                        new
                        {
                            Id = new Guid("10000000-0000-0000-0000-000000000003"),
                            CreatedAt = new DateTime(2026, 3, 15, 19, 34, 57, 383, DateTimeKind.Utc).AddTicks(5169),
                            Name = "President"
                        },
                        new
                        {
                            Id = new Guid("10000000-0000-0000-0000-000000000004"),
                            CreatedAt = new DateTime(2026, 3, 15, 19, 34, 57, 383, DateTimeKind.Utc).AddTicks(5170),
                            Name = "Secretary"
                        },
                        new
                        {
                            Id = new Guid("10000000-0000-0000-0000-000000000005"),
                            CreatedAt = new DateTime(2026, 3, 15, 19, 34, 57, 383, DateTimeKind.Utc).AddTicks(5171),
                            Name = "Treasurer"
                        },
                        new
                        {
                            Id = new Guid("10000000-0000-0000-0000-000000000006"),
                            CreatedAt = new DateTime(2026, 3, 15, 19, 34, 57, 383, DateTimeKind.Utc).AddTicks(5172),
                            Name = "ResidentOwner"
                        },
                        new
                        {
                            Id = new Guid("10000000-0000-0000-0000-000000000007"),
                            CreatedAt = new DateTime(2026, 3, 15, 19, 34, 57, 383, DateTimeKind.Utc).AddTicks(5173),
                            Name = "Tenant"
                        },
                        new
                        {
                            Id = new Guid("10000000-0000-0000-0000-000000000008"),
                            CreatedAt = new DateTime(2026, 3, 15, 19, 34, 57, 383, DateTimeKind.Utc).AddTicks(5174),
                            Name = "Security"
                        },
                        new
                        {
                            Id = new Guid("10000000-0000-0000-0000-000000000009"),
                            CreatedAt = new DateTime(2026, 3, 15, 19, 34, 57, 383, DateTimeKind.Utc).AddTicks(5175),
                            Name = "Maintenance"
                        });
                });
            ...
            modelBuilder.Entity("ApartmentManagementSystem.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2026, 3, 15, 19, 34, 57, 551, DateTimeKind.Utc).AddTicks(6857),
                            Email = "admin@apartment.com",
                            FullName = "System Administrator",
                            IsActive = true,
                            IsOtpVerified = true,
                            IsRegistrationCompleted = true,
                            PasswordHash = "$2a$11$gRcwrhNB5iMTPHxhe0NZtu8XiDJ8OUqrGmQqwDVHb9n2P3s5Qt97O",
            ...
            modelBuilder.Entity("ApartmentManagementSystem.Domain.Entities.UserRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AssignedAt = new DateTime(2026, 3, 15, 19, 34, 57, 551, DateTimeKind.Utc).AddTicks(7372),
                            Id = new Guid("1345ef56-90a8-42e9-8ccc-daf281f78432")
                        });
                });

...
namespace ApartmentManagementSystem.Infrastructure.Migrations
{
    ...
    [Migration("20260129102237_SwaggerMigrate")]
    partial class SwaggerMigrate
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ApartmentManagementSystem.Domain.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2026, 1, 29, 10, 22, 36, 917, DateTimeKind.Utc).AddTicks(2824),
                            Name = "SuperAdmin"
                        },
                        new
                        {
                            Id = new Guid("10000000-0000-0000-0000-000000000002"),
                            CreatedAt = new DateTime(2026, 1, 29, 10, 22, 36, 917, DateTimeKind.Utc).AddTicks(2827),
                            Name = "Manager"
                        },
                        new
                        {
                            Id = new Guid("10000000-0000-0000-0000-000000000003"),
                            CreatedAt = new DateTime(2026, 1, 29, 10, 22, 36, 917, DateTimeKind.Utc).AddTicks(2828),
                            Name = "President"
                        },
                        new
                        {
                            Id = new Guid("10000000-0000-0000-0000-000000000004"),
                            CreatedAt = new DateTime(2026, 1, 29, 10, 22, 36, 917, DateTimeKind.Utc).AddTicks(2829),
                            Name = "Secretary"
                        },
                        new
                        {
                            Id = new Guid("10000000-0000-0000-0000-000000000005"),
                            CreatedAt = new DateTime(2026, 1, 29, 10, 22, 36, 917, DateTimeKind.Utc).AddTicks(2830),
                            Name = "Treasurer"
                        },
                        new
                        {
                            Id = new Guid("10000000-0000-0000-0000-000000000006"),
                            CreatedAt = new DateTime(2026, 1, 29, 10, 22, 36, 917, DateTimeKind.Utc).AddTicks(2831),
                            Name = "ResidentOwner"
                        },
                        new
                        {
                            Id = new Guid("10000000-0000-0000-0000-000000000007"),
                            CreatedAt = new DateTime(2026, 1, 29, 10, 22, 36, 917, DateTimeKind.Utc).AddTicks(2832),
                            Name = "Tenant"
                        },
                        new
                        {
                            Id = new Guid("10000000-0000-0000-0000-000000000008"),
                            CreatedAt = new DateTime(2026, 1, 29, 10, 22, 36, 917, DateTimeKind.Utc).AddTicks(2833),
                            Name = "Security"
                        },
                        new
                        {
                            Id = new Guid("10000000-0000-0000-0000-000000000009"),
                            CreatedAt = new DateTime(2026, 1, 29, 10, 22, 36, 917, DateTimeKind.Utc).AddTicks(2834),
                            Name = "Maintenance"
                        });
                });
            ...
            modelBuilder.Entity("ApartmentManagementSystem.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2026, 1, 29, 10, 22, 37, 131, DateTimeKind.Utc).AddTicks(3813),
                            Email = "admin@apartment.com",
                            FullName = "System Administrator",
                            IsActive = true,
                            IsOtpVerified = true,
                            IsRegistrationCompleted = true,
                            PasswordHash = "$2a$11$OTOM7FYPHfWAt.l769Bu4O3NqHDYebewPWX9kkewC6Kbu5ZpBr4Ju",

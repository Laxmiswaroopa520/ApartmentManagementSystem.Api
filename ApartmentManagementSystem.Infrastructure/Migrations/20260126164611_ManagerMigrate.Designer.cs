...
namespace ApartmentManagementSystem.Infrastructure.Migrations
{
    ...
    [Migration("20260126164611_ManagerMigrate")]
    partial class ManagerMigrate
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ApartmentManagementSystem.Domain.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2026, 1, 26, 16, 46, 10, 952, DateTimeKind.Utc).AddTicks(4391),
                            Name = "SuperAdmin"
                        },
                        new
                        {
                            Id = new Guid("10000000-0000-0000-0000-000000000002"),
                            CreatedAt = new DateTime(2026, 1, 26, 16, 46, 10, 952, DateTimeKind.Utc).AddTicks(4397),
                            Name = "Manager"
                        },
                        new
                        {
                            Id = new Guid("10000000-0000-0000-0000-000000000003"),
                            CreatedAt = new DateTime(2026, 1, 26, 16, 46, 10, 952, DateTimeKind.Utc).AddTicks(4398),
                            Name = "President"
                        },
                        new
                        {
                            Id = new Guid("10000000-0000-0000-0000-000000000004"),
                            CreatedAt = new DateTime(2026, 1, 26, 16, 46, 10, 952, DateTimeKind.Utc).AddTicks(4400),
                            Name = "Secretary"
                        },
                        new
                        {
                            Id = new Guid("10000000-0000-0000-0000-000000000005"),
                            CreatedAt = new DateTime(2026, 1, 26, 16, 46, 10, 952, DateTimeKind.Utc).AddTicks(4401),
                            Name = "Treasurer"
                        },
                        new
                        {
                            Id = new Guid("10000000-0000-0000-0000-000000000006"),
                            CreatedAt = new DateTime(2026, 1, 26, 16, 46, 10, 952, DateTimeKind.Utc).AddTicks(4402),
                            Name = "ResidentOwner"
                        },
                        new
                        {
                            Id = new Guid("10000000-0000-0000-0000-000000000007"),
                            CreatedAt = new DateTime(2026, 1, 26, 16, 46, 10, 952, DateTimeKind.Utc).AddTicks(4459),
                            Name = "Tenant"
                        },
                        new
                        {
                            Id = new Guid("10000000-0000-0000-0000-000000000008"),
                            CreatedAt = new DateTime(2026, 1, 26, 16, 46, 10, 952, DateTimeKind.Utc).AddTicks(4460),
                            Name = "Security"
                        },
                        new
                        {
                            Id = new Guid("10000000-0000-0000-0000-000000000009"),
                            CreatedAt = new DateTime(2026, 1, 26, 16, 46, 10, 952, DateTimeKind.Utc).AddTicks(4461),
                            Name = "Maintenance"
                        });
                });
            ...
            modelBuilder.Entity("ApartmentManagementSystem.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2026, 1, 26, 16, 46, 11, 135, DateTimeKind.Utc).AddTicks(6151),
                            Email = "admin@apartment.com",
                            FullName = "System Administrator",
                            IsActive = true,
                            IsOtpVerified = true,
                            IsRegistrationCompleted = true,
                            PasswordHash = "$2a$11$0SW2OjUt.MaAZncMC5UQD.U2WwWGgDfz1pLLV9DqeqFrR8sB.51Gu",

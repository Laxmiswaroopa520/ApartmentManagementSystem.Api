...
namespace ApartmentManagementSystem.Infrastructure.Migrations
{
    ...
    [Migration("20260226080418_CorrectedPendingRegistrations")]
    partial class CorrectedPendingRegistrations
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ApartmentManagementSystem.Domain.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2026, 2, 26, 8, 4, 17, 855, DateTimeKind.Utc).AddTicks(9651),
                            Name = "SuperAdmin"
                        },
                        new
                        {
                            Id = new Guid("10000000-0000-0000-0000-000000000002"),
                            CreatedAt = new DateTime(2026, 2, 26, 8, 4, 17, 855, DateTimeKind.Utc).AddTicks(9655),
                            Name = "Manager"
                        },
                        new
                        {
                            Id = new Guid("10000000-0000-0000-0000-000000000003"),
                            CreatedAt = new DateTime(2026, 2, 26, 8, 4, 17, 855, DateTimeKind.Utc).AddTicks(9656),
                            Name = "President"
                        },
                        new
                        {
                            Id = new Guid("10000000-0000-0000-0000-000000000004"),
                            CreatedAt = new DateTime(2026, 2, 26, 8, 4, 17, 855, DateTimeKind.Utc).AddTicks(9657),
                            Name = "Secretary"
                        },
                        new
                        {
                            Id = new Guid("10000000-0000-0000-0000-000000000005"),
                            CreatedAt = new DateTime(2026, 2, 26, 8, 4, 17, 855, DateTimeKind.Utc).AddTicks(9658),
                            Name = "Treasurer"
                        },
                        new
                        {
                            Id = new Guid("10000000-0000-0000-0000-000000000006"),
                            CreatedAt = new DateTime(2026, 2, 26, 8, 4, 17, 855, DateTimeKind.Utc).AddTicks(9659),
                            Name = "ResidentOwner"
                        },
                        new
                        {
                            Id = new Guid("10000000-0000-0000-0000-000000000007"),
                            CreatedAt = new DateTime(2026, 2, 26, 8, 4, 17, 855, DateTimeKind.Utc).AddTicks(9660),
                            Name = "Tenant"
                        },
                        new
                        {
                            Id = new Guid("10000000-0000-0000-0000-000000000008"),
                            CreatedAt = new DateTime(2026, 2, 26, 8, 4, 17, 855, DateTimeKind.Utc).AddTicks(9661),
                            Name = "Security"
                        },
                        new
                        {
            ...
            modelBuilder.Entity("ApartmentManagementSystem.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2026, 2, 26, 8, 4, 17, 990, DateTimeKind.Utc).AddTicks(5173),
                            Email = "admin@apartment.com",
                            FullName = "System Administrator",
                            IsActive = true,
                            IsOtpVerified = true,
                            IsRegistrationCompleted = true,
                            PasswordHash = "$2a$11$E8gewQHpmi6y7pIXFvGa1e05DJb69IvczbAmp5aon22vdFuNIzB9G",
            ...
            modelBuilder.Entity("ApartmentManagementSystem.Domain.Entities.UserRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AssignedAt = new DateTime(2026, 2, 26, 8, 4, 17, 990, DateTimeKind.Utc).AddTicks(5725),
                            Id = new Guid("f2e0b289-c0f4-41c8-b69a-8e58069fa03a")
                        });
                });

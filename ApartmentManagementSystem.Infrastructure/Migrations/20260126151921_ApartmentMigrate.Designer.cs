...
namespace ApartmentManagementSystem.Infrastructure.Migrations
{
    ...
    [Migration("20260126151921_ApartmentMigrate")]
    partial class ApartmentMigrate
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ApartmentManagementSystem.Domain.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2026, 1, 26, 15, 19, 20, 485, DateTimeKind.Utc).AddTicks(4042),
                            Name = "SuperAdmin"
                        },
                        new
                        {
                            Id = new Guid("10000000-0000-0000-0000-000000000002"),
                            CreatedAt = new DateTime(2026, 1, 26, 15, 19, 20, 485, DateTimeKind.Utc).AddTicks(4046),
                            Name = "Manager"
                        },
                        new
                        {
                            Id = new Guid("10000000-0000-0000-0000-000000000003"),
                            CreatedAt = new DateTime(2026, 1, 26, 15, 19, 20, 485, DateTimeKind.Utc).AddTicks(4047),
                            Name = "President"
                        },
                        new
                        {
                            Id = new Guid("10000000-0000-0000-0000-000000000004"),
                            CreatedAt = new DateTime(2026, 1, 26, 15, 19, 20, 485, DateTimeKind.Utc).AddTicks(4049),
                            Name = "Secretary"
                        },
                        new
                        {
                            Id = new Guid("10000000-0000-0000-0000-000000000005"),
                            CreatedAt = new DateTime(2026, 1, 26, 15, 19, 20, 485, DateTimeKind.Utc).AddTicks(4051),
                            Name = "Treasurer"
                        },
                        new
                        {
                            Id = new Guid("10000000-0000-0000-0000-000000000006"),
                            CreatedAt = new DateTime(2026, 1, 26, 15, 19, 20, 485, DateTimeKind.Utc).AddTicks(4052),
                            Name = "ResidentOwner"
                        },
                        new
                        {
                            Id = new Guid("10000000-0000-0000-0000-000000000007"),
                            CreatedAt = new DateTime(2026, 1, 26, 15, 19, 20, 485, DateTimeKind.Utc).AddTicks(4053),
                            Name = "Tenant"
                        },
                        new
                        {
                            Id = new Guid("10000000-0000-0000-0000-000000000008"),
                            CreatedAt = new DateTime(2026, 1, 26, 15, 19, 20, 485, DateTimeKind.Utc).AddTicks(4055),
                            Name = "Security"
                        },
                        new
                        {
                            Id = new Guid("10000000-0000-0000-0000-000000000009"),
                            CreatedAt = new DateTime(2026, 1, 26, 15, 19, 20, 485, DateTimeKind.Utc).AddTicks(4056),
                            Name = "Maintenance"
                        });
                });
            ...
            modelBuilder.Entity("ApartmentManagementSystem.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2026, 1, 26, 15, 19, 20, 659, DateTimeKind.Utc).AddTicks(7565),
                            Email = "admin@apartment.com",
                            FullName = "System Administrator",
                            IsActive = true,
                            IsOtpVerified = true,
                            IsRegistrationCompleted = true,
                            PasswordHash = "$2a$11$vH7idGkgOCvwBLNEtKJwY.5sc1kohIpe44V0kcE/IzLSG0rfg21IC",

...
namespace ApartmentManagementSystem.Infrastructure.Migrations
{
    ...
    [Migration("20260208155805_NewDashboardMigrate")]
    partial class NewDashboardMigrate
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ApartmentManagementSystem.Domain.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2026, 2, 8, 15, 58, 4, 220, DateTimeKind.Utc).AddTicks(572),
                            Name = "SuperAdmin"
                        },
                        new
                        {
                            Id = new Guid("10000000-0000-0000-0000-000000000002"),
                            CreatedAt = new DateTime(2026, 2, 8, 15, 58, 4, 220, DateTimeKind.Utc).AddTicks(578),
                            Name = "Manager"
                        },
                        new
                        {
                            Id = new Guid("10000000-0000-0000-0000-000000000003"),
                            CreatedAt = new DateTime(2026, 2, 8, 15, 58, 4, 220, DateTimeKind.Utc).AddTicks(581),
                            Name = "President"
                        },
                        new
                        {
                            Id = new Guid("10000000-0000-0000-0000-000000000004"),
                            CreatedAt = new DateTime(2026, 2, 8, 15, 58, 4, 220, DateTimeKind.Utc).AddTicks(584),
                            Name = "Secretary"
                        },
                        new
                        {
                            Id = new Guid("10000000-0000-0000-0000-000000000005"),
                            CreatedAt = new DateTime(2026, 2, 8, 15, 58, 4, 220, DateTimeKind.Utc).AddTicks(587),
                            Name = "Treasurer"
                        },
                        new
                        {
                            Id = new Guid("10000000-0000-0000-0000-000000000006"),
                            CreatedAt = new DateTime(2026, 2, 8, 15, 58, 4, 220, DateTimeKind.Utc).AddTicks(591),
                            Name = "ResidentOwner"
                        },
                        new
                        {
                            Id = new Guid("10000000-0000-0000-0000-000000000007"),
                            CreatedAt = new DateTime(2026, 2, 8, 15, 58, 4, 220, DateTimeKind.Utc).AddTicks(594),
                            Name = "Tenant"
                        },
                        new
                        {
                            Id = new Guid("10000000-0000-0000-0000-000000000008"),
                            CreatedAt = new DateTime(2026, 2, 8, 15, 58, 4, 220, DateTimeKind.Utc).AddTicks(597),
                            Name = "Security"
                        },
                        new
                        {
                            Id = new Guid("10000000-0000-0000-0000-000000000009"),
                            CreatedAt = new DateTime(2026, 2, 8, 15, 58, 4, 220, DateTimeKind.Utc).AddTicks(600),
                            Name = "Maintenance"
                        });
                });
            ...
            modelBuilder.Entity("ApartmentManagementSystem.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2026, 2, 8, 15, 58, 4, 416, DateTimeKind.Utc).AddTicks(1837),
                            Email = "admin@apartment.com",
                            FullName = "System Administrator",
                            IsActive = true,
                            IsOtpVerified = true,
                            IsRegistrationCompleted = true,
                            PasswordHash = "$2a$11$0zkZj0KCItNrtJpp3awnVuA1SzKv5EhexK6o5vm8bKiHqh16BBBFe",
            ...
            modelBuilder.Entity("ApartmentManagementSystem.Domain.Entities.UserRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AssignedAt = new DateTime(2026, 2, 8, 15, 58, 4, 416, DateTimeKind.Utc).AddTicks(2436),
                            Id = new Guid("7d111e83-bf14-4f64-9df5-9c17269785bb")
                        });
                });

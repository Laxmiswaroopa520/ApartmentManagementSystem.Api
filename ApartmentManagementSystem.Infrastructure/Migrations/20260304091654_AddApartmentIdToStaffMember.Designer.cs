...
namespace ApartmentManagementSystem.Infrastructure.Migrations
{
    ...
    [Migration("20260304091654_AddApartmentIdToStaffMember")]
    partial class AddApartmentIdToStaffMember
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ApartmentManagementSystem.Domain.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2026, 3, 4, 9, 16, 53, 992, DateTimeKind.Utc).AddTicks(1795),
                            Name = "SuperAdmin"
                        },
                        new
                        {
                            Id = new Guid("10000000-0000-0000-0000-000000000002"),
                            CreatedAt = new DateTime(2026, 3, 4, 9, 16, 53, 992, DateTimeKind.Utc).AddTicks(1798),
                            Name = "Manager"
                        },
                        new
                        {
                            Id = new Guid("10000000-0000-0000-0000-000000000003"),
                            CreatedAt = new DateTime(2026, 3, 4, 9, 16, 53, 992, DateTimeKind.Utc).AddTicks(1799),
                            Name = "President"
                        },
                        new
                        {
                            Id = new Guid("10000000-0000-0000-0000-000000000004"),
                            CreatedAt = new DateTime(2026, 3, 4, 9, 16, 53, 992, DateTimeKind.Utc).AddTicks(1800),
                            Name = "Secretary"
                        },
                        new
                        {
                            Id = new Guid("10000000-0000-0000-0000-000000000005"),
                            CreatedAt = new DateTime(2026, 3, 4, 9, 16, 53, 992, DateTimeKind.Utc).AddTicks(1801),
                            Name = "Treasurer"
                        },
                        new
                        {
                            Id = new Guid("10000000-0000-0000-0000-000000000006"),
                            CreatedAt = new DateTime(2026, 3, 4, 9, 16, 53, 992, DateTimeKind.Utc).AddTicks(1802),
                            Name = "ResidentOwner"
                        },
                        new
                        {
                            Id = new Guid("10000000-0000-0000-0000-000000000007"),
                            CreatedAt = new DateTime(2026, 3, 4, 9, 16, 53, 992, DateTimeKind.Utc).AddTicks(1803),
                            Name = "Tenant"
                        },
                        new
                        {
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2026, 3, 4, 9, 16, 53, 992, DateTimeKind.Utc).AddTicks(1804),
                            Name = "Maintenance"
                        });
                });
            ...
            modelBuilder.Entity("ApartmentManagementSystem.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2026, 3, 4, 9, 16, 54, 126, DateTimeKind.Utc).AddTicks(1148),
                            Email = "admin@apartment.com",
                            FullName = "System Administrator",
                            IsActive = true,
                            IsOtpVerified = true,
                            IsRegistrationCompleted = true,
                            PasswordHash = "$2a$11$6ra1QMVy7eU0mT5cgeFNc..aXqGjTvdBH7b6s8eYKk5A3xyPF9nsm",
            ...
            modelBuilder.Entity("ApartmentManagementSystem.Domain.Entities.UserRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AssignedAt = new DateTime(2026, 3, 4, 9, 16, 54, 126, DateTimeKind.Utc).AddTicks(1725),
                            Id = new Guid("57032858-ead8-46ec-8704-f91bcf76f490")
                        });
                });

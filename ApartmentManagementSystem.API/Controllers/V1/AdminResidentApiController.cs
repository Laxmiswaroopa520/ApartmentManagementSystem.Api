...
{
    /// <summary>
    /// API Controller responsible for managing resident onboarding 
    /// and flat assignment operations by SuperAdmin or Manager.
    /// 
    /// This controller handles:
    /// - Viewing pending residents
    /// - Fetching apartments for logged-in user
    /// - Retrieving floors and flats
    /// - Assigning flats to residents
    /// </summary>
    [ApiController]

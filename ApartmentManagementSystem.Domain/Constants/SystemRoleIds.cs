namespace ApartmentManagementSystem.Domain.Constants
{
    public static class SystemRoleIds
    {
        ...
        public static readonly Guid ResidentOwner = Guid.Parse("10000000-0000-0000-0000-000000000006");
        public static readonly Guid Tenant = Guid.Parse("10000000-0000-0000-0000-000000000007");
        public static readonly Guid Security = Guid.Parse("10000000-0000-0000-0000-000000000008");
